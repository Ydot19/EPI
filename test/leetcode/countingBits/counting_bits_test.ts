import {CountingBits} from "../../../leetcode/countingBits/counting_bits.ts";
import {assertEquals} from "https://deno.land/std@0.119.0/testing/asserts.ts";


// Arrange
const impl = new CountingBits()
...
Deno.test("Test Counting Bits Implementation", async (t) => {
    for (const tc of testCases){
        await t.step(tc.description, () => {
            // act
            const actual = impl.SolutionA(tc.n)
            // assert
